...
const PUBLICATIONS = [
  {
    ...
    "opensource": true,
    "volume": "63",
    "recivetime": "2026-04-29",
    "publishtime": "2026-04-29",
    "pages": "104853",
    "codeLink": "https://github.com/GongaoQi/L3DEH",
    "bib": `@article{qi2026label,
      title={Label distribution-driven semantic discrimination enhanced hashing for cross-modal retrieval},
  ...
  },
  {
      ...
      opensource: true,
      volume: "63",
      recivetime:"2026-03-14",
      publishtime:"2026-03-19",
      pages: "104757",
      codeLink:"https://github.com/Jchenxing",
    ...
    },
    {
      ...
      volume: "125",
      recivetime:"2025-06-22",
      publishtime:"2025-07-04",
      pages: "103460",
      bib:`@article{wang2026neural,
      title={Neural Connected Kernel based Multiple Kernel Clustering},
      author={Wang, Jiangyuan and Liu, Qiong and Cai, Mingjie and Ding, Weiping},
  ...
  },
    {
      ...
      codeLink:"https://github.com/Only-sole/feature-selection",
      volume: "33",
      recivetime:"2025-09-09",
...

    {
      ...
      publishtime:"2025-08-07",
      opensource: true, 
      codeLink:"https://github.com/HNU-MingjieCai/FNAN_DPC_S.git",
      pages: "131152",
  ...
  },
 {
    ...
    volume: "319",
    recivetime:"2025-04-03",
    publishtime:"2025-04-19",
    pages: "113498",
  ...
  },
  {
    ...
    volume: "33",
    recivetime:"2024-11-06",
    publishtime:"2024-11-08",
    pages: "881-893",
  ...
  },
  {
    ...
    volume: "263",
    recivetime:"2024-11-03",
    publishtime:"2024-11-10",
    pages: "125705",
 ...
 },
 {
    ...
    volume: "150",
    recivetime:"2023-03-19",
    publishtime:"2023-11-16",
    pages: "111066",
 ...
 },
 {
    ...
    opensource: false, 
    volume: "164",
    recivetime:"2023-08-23",
    publishtime:"2023-10-26",
    pages: "109075",
 ...
 },
 {
    ...
    opensource: false, 
    volume: "8",
    recivetime:"2023-06-03",
    publishtime:"2023-07-08",
    pages: "288299",
...

{
    ...
    opensource: false, 
    volume: "124",
    recivetime:"2021-11-09",
    publishtime:"2023-05-19",
    pages: "106509",
    bib:`@article{long2023convex,
          title={Convex granules and convex covering rough sets},
          author={Long, Zhuo and Cai, Mingjie and Li, Qingguo and Li, Yizhu and Cai, Wanting},
...
},
{
    ...
    opensource: false, 
    volume: "622",
    recivetime:"2022-07-26",
    publishtime:"2022-11-27",
    pages: "710-730",
    bib:`@article{gao2023relative,
          title={A relative granular ratio-based outlier detection method in heterogeneous data},
...
},
{
    ...
    opensource: false, 
    volume: "583",
    recivetime:"2021-01-09",
    publishtime:"2021-10-30",
    pages: "33-35",
    bib:`@article{xu2022selection,
          title={The selection of feasible strategies based on consistency measurement of cliques},
...
},
{
    ...
    opensource: false, 
    volume: "145",
    recivetime:"2021-07-27",
    publishtime:"2022-03-05",
    pages: "18-35",
    bib:`@article{yang2022multigranulation,
          title={Multigranulation fuzzy probabilistic rough set model on two universes},
          author={Yang, Dan and Cai, Mingjie and Li, Qingguo and Xu, Feng},
          journal={International Journal of Approximate Reasoning},
          volume={145},
          pages={18--35},
          year={2022},
...
},
{
    ...
    opensource: false, 
    volume: "52",
    recivetime:"2022-02-09",
    publishtime:"2022-04-04",
    pages: "17636-17651",
    bib:`@article{li2022accelerated,
          title={Accelerated multi-granularity reduction based on neighborhood rough sets},
                    ...
                    {sortedPubs.filter(p => p.year === year).map((pub, i) => (
                      <div key={i} className="flex gap-3 group">
                        ...
                        <div className="flex-1 text-[14px] leading-relaxed text-slate-800 text-justify">
                          ...
                          <a href={pub.doi ? `https://doi.org/${pub.doi}` : ((pub as any).pdfLink || "#")} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-medium ml-1">[DOI]</a>
                          <button 
